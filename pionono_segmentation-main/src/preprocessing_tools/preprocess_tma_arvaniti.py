...
parser.add_argument("--input_dir", "-i", type=str,
                    default="/content/drive/Othercomputers/Mac/Google_Drive/dataset/Arvaniti_TMA/original_dataset/",
                    help="Input directory of dataset.")
parser.add_argument("--output_dir", "-o", type=str,
                    default="/content/drive/Othercomputers/Mac/Google_Drive/dataset/Arvaniti_TMA/resized_dataset_512/",
                    help="Output directory of resized images.")
args = parser.parse_args()

config = vars(args)

dataset_specific_names = {'restructured_dir': "/content/drive/Othercomputers/Mac/Google_Drive/dataset/Arvaniti_TMA/restructured_dataset/",
