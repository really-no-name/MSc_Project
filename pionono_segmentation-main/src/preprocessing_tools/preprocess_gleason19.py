...
#                     default="/data/BasesDeDatos/Gleason_2019/original_dataset/",  # 输入路径
...
#                     default="/data/BasesDeDatos/Gleason_2019/resized_dataset_1024/",  # 输出路径
...
# ----------------------------------------
#  创建黄金标准标签比例文件夹：
create_gold_label_proportion_folders(config['output_dir'] + config['map_dir'],'STAPLE/', [20, 40, 60, 80, 100])